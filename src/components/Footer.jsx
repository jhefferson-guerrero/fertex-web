    ...
    <footer className="w-full bg-zinc-950 border-t-8 border-fertex-red flex flex-col">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-white bg-zinc-950">
        ...
        <div className="p-6 md:p-12 flex flex-col justify-between">
          <div>
            <h3 className="font-display font-black text-3xl md:text-3xl uppercase tracking-tighter text-white mb-4 md:mb-6">Únete a la Familia FERTEX</h3>
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/fertexvillaflores/" target="_blank" rel="noopener noreferrer" className="bg-zinc-950 border-2 border-zinc-800 p-3 md:p-4 hover:border-fertex-red hover:text-fertex-red transition-all duration-300 group" aria-label="Instagram">
