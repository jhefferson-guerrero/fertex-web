...
export default function Footer() {
  return (
    <footer className="w-full bg-zinc-950 border-t-8 border-zinc-950 flex flex-col">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-white bg-zinc-950">
        ...
        <div className="p-8 md:p-12 border-b-8 md:border-b-0 md:border-r-8 border-zinc-800 flex flex-col justify-between">
          <div>
            ...
            <p className="font-sans text-xl md:text-2xl font-medium leading-relaxed text-zinc-400">
              Forjar disciplina, carácter y valores inquebrantables a través del más alto nivel de artes marciales.
            </p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 border-b-8 lg:border-b-0 lg:border-r-8 border-zinc-800 flex flex-col gap-6">
          <h3 className="font-display font-black text-4xl uppercase tracking-tighter text-fertex-red">Sede Central</h3>
          <div className="font-sans text-lg text-zinc-300 font-medium border-l-4 border-white pl-4">
          ...
          <div className="mt-auto">
            ...
            <p className="font-sans text-2xl font-bold text-white">+51 944 351 592</p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-between bg-zinc-900">
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="bg-zinc-950 border-2 border-zinc-800 p-4 hover:border-fertex-red hover:text-fertex-red transition-all duration-300 group" aria-label="Facebook">
              ...
              <a href="#" className="bg-zinc-950 border-2 border-zinc-800 p-4 hover:border-fertex-red hover:text-fertex-red transition-all duration-300 group" aria-label="Instagram">
