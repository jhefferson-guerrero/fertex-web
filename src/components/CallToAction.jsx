...
export default function CallToAction() {
  return (
    <section className="w-full relative py-32 md:py-48 px-4 sm:px-6 lg:px-8 border-b-8 border-zinc-950 overflow-hidden flex flex-col items-center justify-center bg-fertex-red">
      ...
      >
        ...
        <h2 className="font-display font-black text-5xl md:text-6xl lg:text-7xl uppercase text-zinc-950 tracking-tighter leading-[1.1] mb-6 drop-shadow-sm">
          ¿Tienes lo que se necesita?
        </h2>

        <div className="mb-12">
          <p className="font-sans text-lg md:text-xl text-zinc-950 font-bold uppercase tracking-[0.2em]">
