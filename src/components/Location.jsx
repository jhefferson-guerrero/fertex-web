      ...
      <div className="max-w-6xl mx-auto border-8 border-zinc-950 flex flex-col lg:flex-row bg-white shadow-[12px_12px_0px_0px_rgba(24,24,27,1)] lg:shadow-[24px_24px_0px_0px_rgba(24,24,27,1)]">
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center border-b-8 lg:border-b-0 lg:border-r-8 border-zinc-950">
           <h2 className="font-display font-black text-5xl md:text-6xl uppercase text-zinc-950 tracking-tighter mb-10">
             La <span className="text-fertex-red">Sede</span>
           </h2>
           ...
           <div className="font-sans text-lg md:text-xl text-zinc-800 font-medium space-y-8">
             ...
             <div className="border-l-4 border-fertex-red pl-6">
               ...
               <p className="leading-relaxed">+51 944 351 592</p>
             </div>
             <div className="border-l-4 border-fertex-red pl-6 pt-2 flex items-center gap-6">
               ...
               <a href="#" className="text-zinc-950 hover:text-fertex-red transition-colors" aria-label="Facebook">
               ...
               <a href="#" className="text-zinc-950 hover:text-fertex-red transition-colors" aria-label="Instagram">
